...
def train(config):
    ...
    IMG_PATH = {
        ...
        # 对 NewsMKG，IMGID 已含 samples/xxx/yyy，追加 .jpg 时使用此前缀
    ...
    try:
        ...
        # Early Stop
            if f1 > best_f1 + config.patience:
                ...
                print("✅ Model saved to {0}".format(save_dir))
            else:
                patience_counter += 1
                print("📉 No improvement, patience {0}/{1}".format(patience_counter, config.patience_num))
